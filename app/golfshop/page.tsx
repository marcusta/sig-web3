            ...
            <div className="space-y-8">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-slate-400 mb-6 text-lg">Undrar du något kring:</p>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 text-slate-300">
                      ...
                      <a href="mailto:info@premiumgolf.se" className="hover:text-white transition-colors text-lg">info@premiumgolf.se</a>
                  </div>
                   <div className="flex items-center gap-3 text-slate-300">
                      <Clock className="w-5 h-5 text-primary" />
                      <span className="text-lg">Se öppettider på <a href="https://premiumgolf.se" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">premiumgolf.se</a></span>
                  </div>
                </div>
              </div>
            </div>
